...
inline_btn_5 = InlineKeyboardButton('🔗 Привязать NFT из Telegram', callback_data='link_tg_nft')

menu_kb.row(inline_btn_1, inline_btn_2).add(inline_btn_3).add(inline_btn_4).add(inline_btn_5)
...
invest.add(
    InlineKeyboardButton('🌟 CARD [RU] 🌟', callback_data='plus_card'),
    InlineKeyboardButton('🌟 USDT 🌟', callback_data='plus_usdt')
)

un_invest = InlineKeyboardMarkup()
un_invest.add(
    InlineKeyboardButton('🌟 CARD 🌟', callback_data='un_card'),
    InlineKeyboardButton('🌟 CRYPTO 🌟', callback_data='un_crypto')
)

mamont = InlineKeyboardMarkup()
mamont.add(InlineKeyboardButton('🦣 Мои мамонты 🦣', callback_data='my_mamont'))

change = InlineKeyboardMarkup()
change.add(
    InlineKeyboardButton('🇷🇺 RUB', callback_data='change_RUB'),
    InlineKeyboardButton('🇺🇦 UAH', callback_data='change_UAH'),
    InlineKeyboardButton('🇺🇸 USD', callback_data='change_USD'),
    InlineKeyboardButton('🇪🇺 EUR', callback_data='change_EUR'),
    InlineKeyboardButton('🇵🇱 PLN', callback_data='change_PLN'),
    InlineKeyboardButton('🇧🇾 BLN', callback_data='change_BLN'),
)
